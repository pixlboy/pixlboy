...
export default function Interests() {
  return (
    <section className="section-interests content-box">
      <h2 className="section-header">
        <span className="heading">In my free time</span>
      </h2>
          ...
          {/* <li>
            <i className="icons">
              <svg
                ...
                viewBox="0 0 512 512"
                className="icon-s30 svg-inline--fa fa-music"
              >
          ...
          <li>
            <i className="icons">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
                className="icon-s30 svg-inline--fa fa-book"
              >
                <g className="fa-group">
                  <path
                    fill="currentColor"
          ...
          <li>
            <i className="icons">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 640 512"
                className="icon-s30 svg-inline--fa fa-dumbbell"
              >
                <g className="fa-group">
                  <path
                    fill="currentColor"
            ...
            <span className="name">Workout</span>
          </li>
          <li>
            <i className="icons">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 640 512"
                className="icon-s30 svg-inline--fa fa-coffee"
              >
                <g className="fa-group">
                  <path
                    fill="currentColor"
            ...
            <span className="name">Meetups</span>
          </li>         
          <li>
            <i className="icons">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
                className="icon-s30 svg-inline--fa fa-camera-retro"
              >
                <g className="fa-group">
                  <path
                    fill="currentColor"
          ...
          <li>
            <i className="icons">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 384 512"
                className="icon-s30 svg-inline--fa fa-hiking"
              >
                <g className="fa-group">
                  <path
                    fill="currentColor"
                    d="M368 160h-16a16 16 0 0 0-16 16v320a16 16 0 0 0 16 16h16a16 16 0 0 0 16-16V176a16 16 0 0 0-16-16zM240 0a48 48 0 1 0 48 48 48 48 0 0 0-48-48zM125.08 97.94C81.2 87.42 36.73 113 25.76 155.11L.49 253.24c-2.19 8.42 3.14 16.95 11.92 19.06L76 287.55c8.79 2.1 17.68-3 19.87-11.44L137 117c2.19-8.42-3.14-16.95-11.92-19.06z"
                    className="fa-secondary"
                  ></path>
                  <path
                    fill="currentColor"
                    d="M81 472.23a32 32 0 0 0 62.1 15.53l25.24-101L115.51 334zm162-248l22.43 22.43A32 32 0 0 0 288 256h48v-64h-34.75l-46.78-46.78a58.78 58.78 0 0 0-98.59 27.3L129 280.24a32 32 0 0 0 8.42 30.39L224 397.25V480a32 32 0 0 0 64 0v-82.75A63.58 63.58 0 0 0 269.25 352l-46.82-46.82c.15-.5.49-.89.62-1.41z"
                    className="fa-primary"
                  ></path>
                </g>
              </svg>
            </i>
            <span className="name">Hiking</span>
          </li>
          <li>
            <i className="icons">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
                className="icon-s30 svg-inline--fa fa-chart-line"
              >
                <g className="fa-group">
                  <path
                    fill="currentColor"
            ...
            <span className="name">Trading</span>
          </li>
        </ul>
      </div>
    </section>
